 ...
 */
public class XMLGetter extends Result implements Runnable {
    ...
    public XMLGetter(Display display, String url, XMLVO xmlvo, Runnable eventDisplatchThreadRunnable, int retriesRemaining) {
