 ...
 * @author phou
 */
public class JSONModelTest extends MockedStaticInitializers {
    ...
    @Test
    public void basicConstructorModelTest() throws JSONException {
        JSONModel model = new JSONModel(SAMPLE_DATA);
    }
