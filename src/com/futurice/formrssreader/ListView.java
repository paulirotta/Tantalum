...
public class ListView extends Form implements CommandListener {
    ...
    public void paint() {
        ...
        for (int i = startIndex; i < len; i++) {
            ...
            StringItem titleStringItem = new StringItem(null, rSSItem.getTruncatedTitle(), StringItem.PLAIN);
            titleStringItem.setFont(ListView.FONT_TITLE);
            titleStringItem.setLayout(Item.LAYOUT_NEWLINE_AFTER);
            Command cmdShow = new Command("", Command.OK, 1);
            ...
            StringItem dateStringItem = new StringItem(null, rSSItem.getPubDate(), StringItem.PLAIN);
            dateStringItem.setFont(ListView.FONT_DATE);
            dateStringItem.setLayout(Item.LAYOUT_NEWLINE_AFTER);
            Image separatorImage = Image.createImage(getWidth(), 1);
            this.append(titleStringItem);
            this.append(dateStringItem);
            this.append(separatorImage);  
        }
        startIndex = len;
    }
