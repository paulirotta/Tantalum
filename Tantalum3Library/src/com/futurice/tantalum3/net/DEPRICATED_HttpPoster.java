 ...
 * @author combes
 */
public class DEPRICATED_HttpPoster implements Task {
    ...
    public DEPRICATED_HttpPoster(final String url, final int retriesRemaining, final Result result, final String postMessage) {
