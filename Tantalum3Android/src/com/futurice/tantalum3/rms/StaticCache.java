...
public class StaticCache {
	 ...
	 * @param name
	 * @param priority
	 *            , a character from '0' to '9', higher numbers get a preference
	 *            for space
	 * @param handler
	 */
	 ...
	 * @param key
	 * @param bytes
	 * @param putToHeapCache
	 *            - Set "true" unless an overriding method has already done this
	 * @return
	 */
